...
if st.button("Show Recommendation"):
    ...
    with col1:
        ...
        st.image(f"poster/{movie_name[0]}.jpg", width=300, height=300, use_column_width=False)
    with col2:
        st.text(movie_name[1])
        st.image(f"poster/{movie_name[1]}.jpg", width=300, height=300, use_column_width=False)
    with col3:
        st.text(movie_name[2])
        st.image(f"poster/{movie_name[2]}.jpg", width=300, height=300, use_column_width=False)
    with col4:
        st.text(movie_name[3])
        st.image(f"poster/{movie_name[3]}.jpg", width=300, height=300, use_column_width=False)
    with col5:
